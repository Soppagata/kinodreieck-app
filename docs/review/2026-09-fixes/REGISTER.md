...
## Gemeinsame Auslieferung am 17.09.2026

Neue ausdrueckliche taskweite Freigabe von Max: „Du hast die Freigabe alle Fixes ueberall auszuspielen“. Staging und Produktion duerfen gleich sein. Damit sind die zuvor benannten sieben Migrationen, drei Functions, beide Webbranches und die zusammenhaengende Sicherung/Ausfuehrung/Readback-Kette autorisiert; keine erneute Freigabe pro Teilschritt. Die physische iPhone/PWA-Abnahme bleibt ein eigener Nachweis. Kostenpflichtige Anbieterproben werden durch diesen Lieferauftrag nicht benoetigt und nicht gestartet.

Lieferung durch den Master, ohne neue Pruef-/Lieferagenten. Frischer Preflight 19:50 UTC: beide Zielrefs/Webbuilds 14804ce, alle sieben Migrationen fehlen, 26 Radar-v1-Funde und 0 TMDB-Zuordnungen. Kein aktiver Radar-/Entdecken-Lease bei Sicherung. Die vorherigen drei heruntergeladenen Function-Quellabschluesse sind mit 14804ce bytegleich (11/10/19 Dateien). Private Sicherung der betroffenen Identitaetsdaten und SQL-Definitionen ausserhalb des Repositories; isolierte PG17-Wiederherstellung aller Spalten sowie Loeschen/Wiederherstellen der lokalen Kopie erfolgreich. Der lokale V2-Schluessellauf erhaelt alle UUIDs/Nebenfelder und verletzt keine reale Unique-Bedingung.

Status: Gemeinsames Backend ANGEWANDT UND RUECKGELESEN; anschliessende Staging-/Produktions-Weblieferung IN AUSFUEHRUNG. Der unveraenderte abgenommene Produktstand bleibt 9d88b7d; spaetere Register-/Lieferbelege aendern keine Produktbytes.

[Serverabnahme](evidence/RELEASE_BACKEND.json): sieben Migrationen mit atomarer Ledgerzeile und exaktem Original-SQL, Gesamtledger94; ai-task96/JWT=true, Radar73/JWT=false, Entdecken77/JWT=false ACTIVE. Alle 40 transitiven lokalen Quelldateien bytegleich heruntergeladen. Die private Vorher-Sicherung liegt dauerhaft ausserhalb des Repositories; keine persoenlichen Rohdaten oder Credentials wurden in Belege aufgenommen. Function-Buildmarker und beide Weblieferungen folgen mit dem gemeinsamen Liefercommit.
