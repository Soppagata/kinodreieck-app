...
Der nächste kompakte Arbeitsblock verbindet ausschließlich die noch offenen
Praxisgrenzen: aggregierte reale Kontogrößenmessung, zwei Geräte/Kontotrennung,
Sicherheitsdownload und manueller Rechteweg, Feedback/Löschanfrage, mobile
Kino-/Radar-/Entdecken-Nutzung sowie Safari/iPhone/PWA. Der aktive +6h-Checker
wird erst bei seiner späteren Default-Branch-Aktivierung praktisch belegt; es
gibt davor keinen weiteren bezahlten Testlauf. Erst danach wird der exakte RC
eingefroren und die Production-Lieferung separat entschieden.
