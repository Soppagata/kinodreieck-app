      ...
      <div className="kd-entry-shell">
        ...
        <section id="datenschutz-rechtliches" ref={legalRef} className="kd-entry-panel" hidden={!legalOffen} tabIndex={-1} aria-labelledby="legal-titel">
          ...
          <LegalAbschnitt titel="Download, Rechte und Löschung">
            ...
            <p>Nicht übernommene Vorschläge aus der Blog-Referenzerkennung erhalten keinen eigenen Geräte- oder Sicherungstopf. Noch vorhandene serverseitige Vorschläge und Textfundstellen sind im serverseitigen Rechteweg als <code>blogReferenceExtractions</code> berücksichtigt. Zusätzliche Anmelde- und Kontodaten sowie KI-Betriebsdaten sind in der Gerätesicherung nicht enthalten. Die Datei lässt sich derzeit nicht direkt wieder in die App einlesen. Ein vollständiger Download aller Konto- und Serverdaten ist derzeit nicht verfügbar.</p>
