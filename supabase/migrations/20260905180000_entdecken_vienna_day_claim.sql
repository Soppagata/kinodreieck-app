...
-- Der taegliche 02:00-UTC-Scheduler darf nicht durch Sekunden-/Minutenjitter
-- auf einen 48h-Rhythmus fallen. Die Faelligkeit folgt deshalb dem bereits
-- persistierten Wiener Kalendertag. Ein alter Stand ohne last_attempt_on wird
-- konservativ aus dem letzten Erfolgs-/Versuchsanker abgeleitet.
...
comment on function public.kd_entdecken_weekly_refresh_claim(text) is
  'Scheduled: einmal je Europe/Vienna-Kalendertag im 02-UTC-Fenster. Owner: nur bei kurz gesetztem Staging-Override, genau ein Claim auch am selben Tag; maxAttempts 1. Format 6 bleibt 50 Items aus Joyn und OeFI; Radar bleibt 144h.';
