...
| `20260909153000_flixpatrol_usage_ticker.sql` | `bscjgwcntapobyxsiyce` | 2026-09-09 | Codex ueber Management-API | erfolgreich atomar angewandt und rueckgelesen; SHA-256 `a04f9b9c42a7452be11ed1dfced9a0f2ed530f4fab7c378218b3d9d6f343c4ae`; zwei neue Tabellen mit erzwungener RLS, keine Browserrechte, drei aeussere RPCs fuer service_role und gesperrter interner Helper; 56 lokale Tickerchecks gruen, neue Rechte remote bestaetigt; bestehender Live-RLS-Gesamttest 58 bestanden / 15 Fehler bei inaktivem Konto B und anonymen 401-Antworten, Cleanup erfolgreich; siehe `docs/FLIXPATROL_TICKER.md` |
...
| `20260913170000_motn_initial_backfill.sql` | `bscjgwcntapobyxsiyce` | 2026-09-13 | Codex über verknüpfte Management-API | atomar angewandt; SHA-256 `a2609b24edff1cbff5ce472a06982ef4f013a9f201242cff22be4a60a3bfad18`; begrenzte einmalige Startbefüllung und täglicher UTC-Lauf. |
| `20260913173000_motn_watchmode_identity.sql` | `bscjgwcntapobyxsiyce` | 2026-09-13 | Codex über verknüpfte Management-API | atomar angewandt; SHA-256 `3ab229f4fd65a001ec4b35523b33630534261f83c36dffbc2719f7d37928c1cb`; exakter Titel/Jahr/Typ-Abgleich bei fehlenden Watchmode-IDs, Mehrdeutigkeitssperre und Fortsetzung nach Ende des Startkontingents. |
| `20260913180000_motn_change_checks.sql` | `bscjgwcntapobyxsiyce` | 2026-09-13 | Codex über verknüpfte Management-API | atomar angewandt und rückgelesen; SHA-256 `c9b9cf86704497adbe111e96a8ecc642096c6c607eeded62ade8505232be94bc`; tägliche Änderungsprüfung, 48-Stunden-Sperre nach vollständigem Abgleich, fortsetzbare Cursor und gemeinsamer Anfragedeckel. |
| `20260913190000_motn_usage_ticker.sql` | `bscjgwcntapobyxsiyce` | 2026-09-13 | Codex über verknüpfte Management-API | atomar angewandt und rückgelesen; SHA-256 `cb8c23907a15fc6da41bbe0b354d1e1ae482e1d751b34281d900e4ec6e5cd71e`; providerfreier serverseitiger Verbrauchsticker für das spätere Staging-Element. |
| `20260917095000_review_radar_client_compat.sql` | `bscjgwcntapobyxsiyce` | 2026-09-17 | Codex nach ausdruecklicher Owner-Freigabe ueber verknuepfte Management-API | einzeln atomar mit Ledger angewandt; Original-SQL im Ledger bytegleich, Vertrag rueckgelesen; SHA-256 `092c2d14f46ff2eed40aea4f4447ae8138da5295d08e2a5e5172642961ff6257`; [Abnahme](../../docs/review/2026-09-fixes/evidence/RELEASE_BACKEND.json) |
| `20260917100000_review_radar_text_identity.sql` | `bscjgwcntapobyxsiyce` | 2026-09-17 | Codex nach ausdruecklicher Owner-Freigabe ueber verknuepfte Management-API | einzeln atomar mit Ledger angewandt; Original-SQL im Ledger bytegleich, Vertrag rueckgelesen; alle 26 Radar-UUIDs und Nebenfelder unveraendert; SHA-256 `82661ea4f2d1f6c968b5a3f719e0684096597bada2a5006b7be7d7786ed1070d`; [Abnahme](../../docs/review/2026-09-fixes/evidence/RELEASE_BACKEND.json) |
| `20260917101000_review_radar_context_year.sql` | `bscjgwcntapobyxsiyce` | 2026-09-17 | Codex nach ausdruecklicher Owner-Freigabe ueber verknuepfte Management-API | einzeln atomar mit Ledger angewandt; Original-SQL im Ledger bytegleich, Vertrag rueckgelesen; SHA-256 `738cbf27b9748e0ee5d2fd95631e8d2d4ad9a716d5f3a2edc3ebb674817c2d80`; [Abnahme](../../docs/review/2026-09-fixes/evidence/RELEASE_BACKEND.json) |
| `20260917110000_review_filmwissen_identity.sql` | `bscjgwcntapobyxsiyce` | 2026-09-17 | Codex nach ausdruecklicher Owner-Freigabe ueber verknuepfte Management-API | einzeln atomar mit Ledger angewandt; Original-SQL im Ledger bytegleich, Vertrag rueckgelesen; SHA-256 `e185b0e736836ae598f8675ee994dbc6502ae2c176c41a595aedd5ce8b06a55e`; [Abnahme](../../docs/review/2026-09-fixes/evidence/RELEASE_BACKEND.json) |
| `20260917120000_review_streaming_freshness_anchors.sql` | `bscjgwcntapobyxsiyce` | 2026-09-17 | Codex nach ausdruecklicher Owner-Freigabe ueber verknuepfte Management-API | einzeln atomar mit Ledger angewandt; Original-SQL im Ledger bytegleich, Vertrag rueckgelesen; SHA-256 `104a29402c3c442d7504093795904ce4414dc78f71a4dd19ebbec3eca75aec52`; [Abnahme](../../docs/review/2026-09-fixes/evidence/RELEASE_BACKEND.json) |
| `20260917123000_review_mail_rate_bucket_retention.sql` | `bscjgwcntapobyxsiyce` | 2026-09-17 | Codex nach ausdruecklicher Owner-Freigabe ueber verknuepfte Management-API | einzeln atomar mit Ledger angewandt; Original-SQL im Ledger bytegleich, Vertrag rueckgelesen; SHA-256 `ae915a36f2686b9b2dbd15f0d553ba0c2d538fc76e6bf8796c642d1d3ac632aa`; [Abnahme](../../docs/review/2026-09-fixes/evidence/RELEASE_BACKEND.json) |
| `20260917130000_review_entdecken_ofi_identity.sql` | `bscjgwcntapobyxsiyce` | 2026-09-17 | Codex nach ausdruecklicher Owner-Freigabe ueber verknuepfte Management-API | einzeln atomar mit Ledger angewandt; Original-SQL im Ledger bytegleich, Vertrag rueckgelesen; SHA-256 `3b4c03230e7afd9ef87be92b1bc7b419a61282f2fdd3072bc5b158bf01bbd07b`; [Abnahme](../../docs/review/2026-09-fixes/evidence/RELEASE_BACKEND.json) |
