/* Privat-Release-Regression fuer die lokale Einzeldatei. Historische
   Demo-/Startwahlmarker duerfen die neue leere Localmodus-Grenze nicht
   umgehen. Die eingebettete Offline-Beilage bleibt im Artefakt, wird aber
   ohne Konto nicht automatisch geladen. */
...
dom.window.close();
console.log(`\nPRIVATE-RELEASE-PERSONALMODUS-TEST BESTANDEN (${checks}/${checks})`);
process.exit(0);
