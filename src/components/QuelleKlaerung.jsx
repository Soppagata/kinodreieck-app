...
export function QuelleKlaerung({ eintraege, onFertig, onSpaeter }) {
  ...
  return createPortal(
    <div role="dialog" aria-modal="true" aria-label="Quellen klären"
      ...
      <div style={{ background: T.saalHoch, border: "1px solid " + T.wolfram, borderRadius: 8, maxWidth: 620, width: "100%", boxSizing: "border-box", maxHeight: "88dvh", overflowY: "auto", overscrollBehavior: "contain", padding: "22px 24px", boxShadow: "0 12px 48px rgba(0,0,0,0.6)" }}>
