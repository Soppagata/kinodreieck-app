...
Titel sowie widersprüchliche IMDb-/TMDb-IDs werden nicht verbunden.
...
Der nächste 14-Tage-Ablauf ist Teil der ausgegebenen Version. Eine Quellen- oder
Zeitänderung liefert für einen alten, ansonsten gültigen Cursor
...
Felder aus der alten Known-Lane werden beim Aufbau der neutralen Projektion
entfernt. `kd_streaming_catalog` und alle Originaltabellen bleiben unverändert.
...
`/private/tmp/kd-streaming-performance-20260913`. Der belegte Lauf umfasste 12
Checks. Auf 25.023 vereinigten realen Titeln dauerte der einmalige lokale
Projektionsaufbau rund 13,1 Sekunden; die erste 20er-Seite für Netflix, Disney+
