...
function ProduktionsRechtliches() {
  return <>
    ...
    <LegalAbschnitt titel="Quellen und optionale KI-Funktionen">
      ...
      <p>Vorschläge und kurze Textfundstellen aus dieser Erkennung bleiben kontogetrennt 24 Stunden abrufbar und werden durch den stündlichen Purge im normalen Schedulerbetrieb spätestens nach 25 Stunden gelöscht. Sie werden weder automatisch übernommen noch veröffentlicht.</p>
    </LegalAbschnitt>
      ...
      <div className="kd-entry-shell">
        ...
        <section id="datenschutz-rechtliches" ref={legalRef} className="kd-entry-panel" hidden={!legalOffen} tabIndex={-1} aria-labelledby="legal-titel">
          ...
          <LegalAbschnitt titel="KI- und Suchanbieter">
            ...
            <p>Geprüfte Vorschläge und kurze Textfundstellen hält Kinodreieck kontogetrennt 24 Stunden zur erneuten Anzeige bereit. Danach sind sie nicht mehr abrufbar; der stündliche Purge entfernt sie im normalen Schedulerbetrieb spätestens nach 25 Stunden. Eine Kontolöschung entfernt noch vorhandene Datensätze zusätzlich über die Kontobindung.</p>
