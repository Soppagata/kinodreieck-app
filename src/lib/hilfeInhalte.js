...
const BEREICHE = [
  ...
  },
  {
    ...
    details: [
      ...
      "Wenn du die optionale Funktion „Titel im Text erkennen (KI)“ eingeschaltet hast, sendet erst dein Klick die Überschrift und den vollständigen aktuellen Blogtext an Anthropic. Persönliche Angaben im Text werden mitgesendet. „Anonym veröffentlichen“ anonymisiert diese KI-Eingabe nicht.",
      "Du prüfst die Fundstellen, klärst mehrdeutige Titel und wählst auch mehrere Referenzen selbst aus. Kein Vorschlag wird automatisch übernommen oder veröffentlicht; Schreiben, Speichern und manuelle Referenzen funktionieren ohne diese KI-Funktion weiter.",
    ...
    suchwoerter: ["entdecken", "empfehlungen", "radar", "meinungen", "artikel", "blog", "blogreferenzen", "titel erkennen", "rotlink"],
    ziel: "blog",
  },
  {
    id: "daten",
...
const AKTIONEN = [
  ...
  },
  {
    ...
    text: "Öffne Settings → Personalisierung & KI → Manuelle KI-Funktionen. Dort steuerst du die KI-Aktionen, die du in diesem Browser selbst startest, einschließlich der standardmäßig ausgeschalteten Erkennung von Titeln in Blogtexten.",
    suchwoerter: ["ki funktionen", "ki einstellen", "prognose", "prognose einstellen", "filmwissen", "filmwissen einstellen", "blogreferenzen", "titel im blogtext erkennen", "deutung", "ki deutung"],
    direkteSuchwoerter: ["ki funktionen", "ki einstellen", "prognose einstellen", "filmwissen einstellen", "blogreferenzen", "titel im blogtext erkennen", "ki deutung"],
    bereichId: "daten",
    ziel: "daten",
  },
  {
    id: "blogreferenzen-erkennen",
    titel: "Titel im Blogtext erkennen",
    text: "Aktiviere zuerst unter Settings → Personalisierung & KI → Manuelle KI-Funktionen die Blogreferenzen. Im Blog startet erst „Titel im Text erkennen (KI)“ die Übertragung von Überschrift und aktuellem Blogtext. Prüfe mehrdeutige Titel und wähle die gewünschten Referenzen selbst; die KI speichert oder veröffentlicht den Artikel nicht.",
    suchwoerter: ["blogreferenzen erkennen", "titel im blogtext", "titel erkennen ki", "film im blog verlinken", "mehrere blogreferenzen"],
    direkteSuchwoerter: ["blogreferenzen erkennen", "titel im blogtext", "titel erkennen ki"],
    bereichId: "blog",
    ziel: "blog",
  },
  {
