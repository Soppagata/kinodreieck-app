...
export const PRIVATE_PROVIDER_REGISTRY = Object.freeze([
  ...
  provider({
    ...
    usage: "optional bei bewusst gestarteten und freigeschalteten KI-Aufgaben; zusätzlich kann ein serverseitig freigegebener automatischer Radar-Lauf aktive Radarziele unabhängig vom lokalen KI-Schalter prüfen",
