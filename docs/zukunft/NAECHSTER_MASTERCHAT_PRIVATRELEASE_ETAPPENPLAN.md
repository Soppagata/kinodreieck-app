...
| M3 | Feedback ohne Namensangabe und authentifizierte Löschanfrage laufen über einen begrenzten, servergebundenen Mailweg | GEBAUT | Endpoint `484a63b` und Browseroberfläche `a300756` sind lokal integriert und standardmäßig fail-closed; Resend-Adapter, Migration, Aktivierung und Praxis offen. Echter Probe-Request weiter `0/3`, weil der lokale Keychain-Eintrag fehlt |
