...
Auch die ausdruecklich nachbeauftragte zweite Nutzen-/Regressionspruefung ist abgeschlossen: **49 ERLEDIGT / BEHALTEN, 239 Kriterien erneut belegt, keine neue bestaetigte lokale Produktregression.** [Einzelurteile, Nutzen und Risiken](evidence/benefit-audit/REVIEW.md) und [maschinelle 49er-Zuordnung](evidence/benefit-audit/REVIEW.json) gelten fuer a69a32b mit denselben Produktbytes. Drei konkret belegte Vertraege mit alten Clients bleiben als Auslieferungsrest offen; weder Staging noch Produktion wurde gepusht.
...
| 5 | [E08-002](../2026-09-vollreview/tickets/E08/KD-REV-E08-002.md) | P2 | P05 | Baumeister-P05 | DONE | 9b3da55 + b88c403 | [P05](evidence/P05.md): SQL-/Teilpersistenz-/Personen-/Browserpruefungen; [R-P05](evidence/R-P05.md): Mischbetrieb integriert, Nachpruefung folgt |
...
| 7 | [E10-004](../2026-09-vollreview/tickets/E10/KD-REV-E10-004.md) | P2 | P06 | Baumeister-P06 | DONE | 7def1b0 + f957fbe + 8f010e7 | [P06](evidence/P06.md); 36 echte Formular-/Prognosefaelle und 9 Parserfaelle; unabhaengig ERLEDIGT auf 114b268; [R-P06](evidence/R-P06.md): Mischbetrieb integriert, Nachpruefung folgt |
...
| 34 | [E08-001](../2026-09-vollreview/tickets/E08/KD-REV-E08-001.md) | P2 | P05 | Baumeister-P05 | DONE | 9b3da55 + b88c403 | [P05](evidence/P05.md): SQL-/Teilpersistenz-/Personen-/Browserpruefungen; [R-P05](evidence/R-P05.md): Mischbetrieb integriert, Nachpruefung folgt |
...
| 37 | [E07-002](../2026-09-vollreview/tickets/E07/KD-REV-E07-002.md) | P2 | P08 | Baumeister-P08 | DONE | 338948d + 990e779 | [P08](evidence/P08.md): fokussierte Produkt-/Integrationsnachweise; [R-P08](evidence/R-P08.md): Mischbetrieb integriert, Nachpruefung folgt |
...
Die konkret bestaetigten Auslieferungsgrenzen bleiben von den 49 lokalen Ticketstatus getrennt:

| Gemeinsamer Vertrag | Betroffene Fixes / Owner | Risiko fuer bisherige Prod-/PWA-Leser | Status / notwendiger Schritt |
|---|---|---|---|
| Radar-Fundschluessel v1 → v2 | E08-002 / P05 | Die Migration schreibt bestehende Identitaeten um. Alte Leser und Auswahlpfade verwenden weiterhin v1; der letzte read-only Preflight zaehlt 26 bestehende v1-Funde. | OFFEN fuer gemeinsame Auslieferung. Isoliertes Staging oder ausdruecklich freigegebene gemeinsame Umstellung mit gepruefter Altclientstrategie, Sicherung und Readback. |
| Filmwissen: numerische → typisierte TMDB-Transportkennung | E10-004 / P06 | Neuer Client und alter Server sowie alter Client und neuer Server sprechen verschiedene Kennungsvertraege. Der aktuelle Server akzeptiert nur den alten numerischen Vertrag; persoenliche gespeicherte IDs bleiben dagegen bewusst numerisch. | OFFEN fuer gemeinsame Auslieferung. Passendes Client-/Function-/SQL-Versionsfenster und explizite Entscheidung fuer verbleibende Altclients. Keine Ruecknahme der Werkarttrennung, um scheinbare Kompatibilitaet herzustellen. |
| Entdecken: OeFI-Annotationen in Feedformat 8/9 | E07-002 / P08 | Der alte Browser weist einen ansonsten gueltigen neuen 50er-Feed wegen des zusaetzlichen Feldes insgesamt ab. | OFFEN fuer gemeinsamen Producerstart. Isolierter Feed/Backend oder kompatible Einfuehrung der Leser vor Aktivierung des Producers; ein Frontend-Push allein beweist dies nicht. |
...
|---|---|---|---|
| R-P05 / Radar | p05_rollout / `/private/tmp/kd-review49-rollout-p05-20260917` | Radar-Clientvertrags-/Servicedateien, radar-websearch-task, neue vorgezogene Migration `20260917095000_review_radar_client_compat.sql`, eigene `review49_rollout_p05_*` Tests/Fixtures und `evidence/R-P05.md` | INTEGRIERT; Nachpruefung folgt |
| R-P06 / Filmwissen | p06_rollout / `/private/tmp/kd-review49-rollout-p06-20260917` | Filmwissen-Helper/Transport/Service/Prognoseauftrag, ai-task/filmwissen-task, gegebenenfalls ausschliesslich Filmwissen-eigener Helper, ausdruecklich freigegebener kleiner Numeric-Guard in der noch unremote `20260917110000_review_filmwissen_identity.sql`, eigene `review49_rollout_p06_*` Tests/Fixtures und `evidence/R-P06.md` | INTEGRIERT; Nachpruefung folgt |
| R-P08 / Entdecken | p08_rollout / `/private/tmp/kd-review49-rollout-p08-20260917` | webDiscoveryFeed/entdeckenDailyFeed/entdeckenUi, entdecken-daily-task, keine neue Migration erforderlich, eigene `review49_rollout_p08_*` Tests/Fixtures und `evidence/R-P08.md` | INTEGRIERT; Nachpruefung folgt |
