...
Gemeinsame, noch nicht veröffentlichte Integrationsbasis ist
`2a50386` auf `codex/road-to-live-integration-20260902`. Sie führt den auf
`staging` und `main` ausgelieferten Login-/Konto-Recovery-Stand `24bbddc` mit
den vorbereiteten E1-, E2- und E3a-Grundlagen zusammen. Der Primärcheckout
...
| M5 | Bereinigter, integrierter Privatrelease-Kandidat mit einem gemeinsamen Abschlusslauf | OFFEN | folgt nach M1–M4 |
