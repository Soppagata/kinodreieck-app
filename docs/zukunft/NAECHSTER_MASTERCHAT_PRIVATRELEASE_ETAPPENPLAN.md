...
| PR-03 / P2, E2 | Vorhandenen Sync kurz erfassen und wiederverwenden; nur BEHALTEN-Datentöpfe; eindeutig persönlicher Server-Livestand; Browser Offlinekopie/Cache, nicht einzige Heimat; A/B-Kontogrenze auch für Revisionen/Export/Restore; Gerätewechsel/Logout/Relogin richtiger Stand; konkurrierende Revisionen erkennen, nicht überschreiben | Baumeister Kontodaten; Integration Meister | GEBAUT als wiederverwendeter lokaler Technikstand bis `2d58ee1`: zentrale Registry mit 18 persönlichen Töpfen, optimistische Revisionen, Konflikterkennung ohne stilles Überschreiben, fremde Zeilen ausgeschlossen sowie Konto-/Treibergenerationen gebunden. Kein neuer Sync und keine Radar-/Entdecken-Änderung. Account-Treiber 55/55; Kontoautoladen 8/8, Übergabekontext 18/18 und Session 37/37 aus dem integrierten P1-Beleg übernommen. Echter zweiter Gerätewechsel, Remote-Readback und praktische Konfliktabnahme OFFEN |
| PR-04 / P2, E2 | Kein neues Backup-/Historisierungssystem; bestehende Revisionen/Konflikterkennung; keine zusätzliche Restore-/Retentionzusage; veralteter Sieben-Tage-/Revisionszustand deterministisch statt Warten; vor lokaler Gesamtlöschung portabler JSON-Sicherheitsdownload, danach separate Bestätigung; sichtbarer Kontoexport vollständig für alle BEHALTEN-Flächen und genau erklärt, sonst verborgen plus manueller Rechteweg | Baumeister Kontodaten; Integration Meister | GEBAUT als lokaler Teilstand in `6370c4a` und `2d58ee1`: gastgebundene portable JSON-Sicherheitskopie dieses Geräts, ausdrücklich kein Server-/Kontoexport; erst der ausgelöste Download schaltet die getrennte lokale Löschung frei. Sitzungs-/Kontextwechsel sperrt fail-closed, die Löschung wird rückgelesen und bei Teilfehler zurückgerollt; Auth, Katalog/PWA, Serverkonto sowie Kino/Streaming bleiben unberührt. Restore-Einstieg und Wiederherstellungszusage sind aus der Release-UI entfernt; vollständiger Kontoexport bleibt doppelt flag-geschützt und validiert. Lokal grün: Löschschutz 9/9, Exporttrennung 16/16, Wortlaut 14/14, Single-File-Build und Localmodus 13/13. Praktischer Browserdownload samt Dateiprüfung/Löschung/Reload, Sieben-Tage-Zustand und manueller Rechteweg OFFEN |
...
| PR-10 / P6, E6 | Ein exakter integrierter RC: vollständige Mocksuite/Production-Build/finaler Diff-/Secret-/Bundlecheck; anonyme Daten-/Demo-/Backup-/Mapgrenze; relevante RLS/Kontotrennung/Readbacks, Backup/Restore nur an nötiger Mutation; eine Praxismatrix Login/Legal/leer lokal/Eintrag+Refresh/Login ohne Merge/Gast nach Logout/A-B-Grenze/Sync+zweites Gerät+Konflikt+defekter Cache/Sicherheitsdownload+Bestätigung/Export oder manuelle Rechte/Löschmail/Feedback/Kinomobil/Radar+Entdecken/KI-aus+Anbieterausfall/aktiver 6h-Checker/PWA+Safari/iPhone+Tastatur+320/393/Desktop; bestehende Belege übernehmen; schmaler Betrieb für Sync/Functions/Mail/Kosten/Support/Cache/Rollback; keine neue Featurelogik in E6; RC/Push/CI/Backend/Deploy/Praxis/Release-Tag getrennt; private Lieferung kinodreieck.at nur autorisiert, keine Ankündigung/Demo/Registrierung, höchstens 15 Einladungen | Meister / Integrationsowner | BEGRENZTES FINAL_LOCAL der geänderten Flächen GRÜN, kein RC: Kontoautoladen 8/8, Übergabekontext 18/18, Session 37/37, Katalog 100/100, Localmodus 9/9, Login 9/9, Kinofilter 11/11, Kinoempfehlungen 5/5 sowie Login/Kino Chromium+WebKit 12/12; Online-/Production-/Singlefile-Build grün. P2 ergänzt lokal integriert Löschschutz 9/9, Exporttrennung 16/16, Wortlaut 14/14, Account-Treiber 55/55 und Localmodus im neuen Single-File-Build 13/13. Function-Mocks 334/334 aus dem vorherigen unveränderten Backend-Gate übernommen, nicht erneut gestartet. Die vollständige `npm test`-Kette stoppt am unveränderten `radar_initial_search_test`; derselbe Fehler ist auf der Staging-Basis `31f37f6` reproduzierbar, daher keine Radaränderung oder erneute Radar-/Vollsuite in P2. Praktischer Browserdownload, tatsächliche Dateiprüfung/Löschung/Reload, vollständiger Kontoexport beziehungsweise manueller Rechteweg, Sync auf zweitem Gerät, Konflikt-/Defektcache-Szenarien, reale Max-Datenmessung, vollständiger RC, Leak-/OSS-Beleg, Remote und Praxis OFFEN |
