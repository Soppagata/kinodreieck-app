...
check("Bereiche besitzen exakt 6 Felder", HILFE_BEREICHE.length > 0 && HILFE_BEREICHE.every((bereich) => {
  ...
  return keys.size === 6
    && [...keys].every((feld) => erwartet.includes(feld))
...
check("direkte Suchbegriffe sind vollständig", DIREKTE_AKTIONEN.length === 59);
...
check("Mehraktions-Matrix nutzt alle 15 Aktions-IDs", KANONISCHE_AKTIONEN.length === 15);
