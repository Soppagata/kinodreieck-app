...
/* Der Ergebnisvertrag ist fuer Suche, Profilextraktion, Prognose, Filmwissen,
   Medienstapel und Bloganalyse additiv:
   ...
   Prognose-, Filmwissens- oder Blogprofilpfade geraten. */
export function normalisiereAiErgebnis(task, result) {
  if (!["intelligent-search", "profile-extract", "film-forecast", "filmwissen-synthese", "media-batch-extract", "blog-profile-extract"].includes(task)) return result;
