...
function ProduktionsRechtliches() {
  return <>
    ...
    <LegalAbschnitt titel="Feedback, Rechte und Löschung">
      ...
      <p>Unter Settings → Konto, Daten &amp; Sicherung kannst du eine JSON-Sicherheitskopie persönlicher Inhalte dieses Geräts herunterladen, zum Beispiel Mediathek, Blogartikel mit übernommenen Referenzen, Listen, Einstellungen und Geschmacksprofil. Nicht übernommene KI-Vorschläge sind kein eigener Geräte- oder Sicherungstopf. Bei einem aktiven Konto versucht die Sicherung vorher, den aktuellen Synchronisationsstand zu laden.</p>
        ...
        <section id="datenschutz-rechtliches" ref={legalRef} className="kd-entry-panel" hidden={!legalOffen} tabIndex={-1} aria-labelledby="legal-titel">
          ...
          <LegalAbschnitt titel="KI- und Suchanbieter">
            ...
            <ul>
              ...
              <li>beim Stapelimport die eingegebene Titelliste und gegebenenfalls Kurzbewertungen;</li>
              <li>bei der bestehenden Blog-Geschmacksanalyse Titel, Text, Genres und Tags des ausdrücklich ausgewählten Artikels, ohne Konto- oder Artikelkennung;</li>
              <li>bei „Titel im Text erkennen (KI)“ erst nach deinem Klick die Überschrift und den vollständigen begrenzten aktuellen Blogtext. Persönliche Angaben, die du selbst in den Text geschrieben hast, sind Bestandteil dieser Eingabe. Es werden keine Konto- oder Artikelkennung, Mediathek oder Geschmacksdaten hinzugefügt;</li>
            ...
            <p>Die Blog-Referenzerkennung übernimmt oder veröffentlicht keinen Vorschlag automatisch. „Anonym veröffentlichen“ betrifft die Anzeige des veröffentlichten Artikels und anonymisiert nicht den Inhalt der von dir gestarteten KI-Anfrage.</p>
            <p>Geprüfte Vorschläge und kurze Textfundstellen hält Kinodreieck kontogetrennt 24 Stunden zur erneuten Anzeige bereit. Danach sind sie nicht mehr abrufbar und werden automatisch in stündlichen Löschläufen entfernt. Bei Rückstau oder Betriebsstörungen kann die physische Löschung später erfolgen. Eine Kontolöschung entfernt noch vorhandene Datensätze zusätzlich über die Kontobindung.</p>
          ...
          <LegalAbschnitt titel="Download, Rechte und Löschung">
            <p>Unter Settings → Konto, Daten &amp; Sicherung kannst du eine JSON-Sicherheitskopie persönlicher Inhalte dieses Geräts herunterladen, zum Beispiel Mediathek, Blogartikel mit übernommenen Referenzen, Listen, Einstellungen und Geschmacksprofil. Bei einem aktiven Konto versucht die Sicherung vorher, den aktuellen Synchronisationsstand zu laden.</p>
            <p>Nicht übernommene Vorschläge aus der Blog-Referenzerkennung erhalten keinen eigenen Geräte- oder Sicherungstopf. Noch vorhandene serverseitige Vorschläge und Textfundstellen werden im Konto-/Rechteweg nur über die ausdrücklich angeforderte Erweiterung <code>include=blog-reference-extract-v1</code> als <code>blogReferenceExtractions</code> ergänzt; die normale Eigendatenantwort bleibt unverändert. Zusätzliche Anmelde- und Kontodaten sowie KI-Betriebsdaten sind in der Gerätesicherung nicht enthalten. Die Datei lässt sich derzeit nicht direkt wieder in die App einlesen. Ein vollständiger Download aller Konto- und Serverdaten ist derzeit nicht verfügbar.</p>
