...
Stand: 08.08.2026
Referenz: `audit/fixbatch1` bei `3ae1300`
...
ist testbar, aber nicht funktionsneutral.
...
| P3 | Finder-Kleinlücken | `doku → dokumentation` verweist auf ein nicht existentes Genre, `ß` normalisiert unschön, weiche und ausschließende Chips sind in zwei Themes farbgleich. | Kleiner bestätigter Backlog nach Erreichbarkeitsfix. |
