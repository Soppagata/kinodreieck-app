...
comment on function public.kd_entdecken_weekly_refresh_claim(text) is
  'Scheduled: einmal je Europe/Vienna-Kalendertag im 02-UTC-Fenster. Owner: nur bei kurz gesetztem Staging-Override, genau ein Claim auch am selben Tag; maxAttempts 1. Format 6 bleibt 25 Items aus Netflix AT und OeFI; Radar bleibt 144h.';
